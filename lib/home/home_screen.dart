      ...
      body: Stack(
        ...
        children: [
         GetBuilder<HomeScreenController>(
                          ...
                          InkWell(
                              onTap: () {
                                if(!loginSignupController.isLoggedIn){
                                  ...
                                  homeScreenController.update();return;
                                }
          ...
          GetBuilder<HomeScreenController>(
            builder: (context) {
              return homeScreenController.showLoginPrompt?Container(
                alignment: Alignment.center,
...
Text("Please Sign in or Log in",style: GoogleFonts.poppins(
    fontSize: 16.sp,
    color: Colors.white,
    fontWeight: FontWeight.bold,
    wordSpacing: 1.sp,
    ...
    width: 300.w,text:"Sign up",function: (){Get.to(()=>SignUpScreen());}),
    SizedBox(height: 10.h,),
    CustomButton(    height: 59.h,
    width: 300.w,text:"Log in",function: (){Get.to(()=>SignUpScreen());}),
      SizedBox(height: 10.h,),
    CustomButton(    height: 59.h,
    width: 300.w,text:"Cancel",function: (){homeScreenController.showLoginPrompt=false;homeScreenController.update();}),
    ],),
